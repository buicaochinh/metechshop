...
class Premium extends \Magento\Config\Block\System\Config\Form\Field {
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element) {
        ...
        if (in_array('curl', get_loaded_extensions())) {
            ...
            $file = 'https://www.hiddentechies.com/documentation/notifications/latest_notifications_etrend_premium.xml';
